...
class QuestSessionManager
{
     ...
     * @return bool
     */
    private function updateSessionPlayerId(QuestSession &$session, ?int $playerId): bool
    {
     ...
     * @return bool
     */
    private function updateSessionQuestId(QuestSession &$session, ?int $questId): bool
    {
     ...
     * @return bool
     */
    private function updateSessionClientId(QuestSession &$session, ?string $clientId): bool
    {
    ...
    private function updateSession(QuestSession $session, ?int $questId, ?int $playerId, ?string $clientId): bool
    {
        ...
        $needUpdate = $this->updateSessionPlayerId($session, $playerId) || $this->updateSessionQuestId($session, $questId) || $this->updateSessionClientId($session, $clientId);

 ...
 * @property int|null $player_turn Player's turn number during the game phase
 *
...
class QuestPlayer extends \yii\db\ActiveRecord
{
    ...
    public function rules() {
        return [
            [['left_at', 'reason', 'player_turn'], 'default', 'value' => null],
            [['onboarded_at'], 'default', 'value' => 0],
            [['status'], 'default', 'value' => AppStatus::ONLINE->value],
            [['quest_id', 'player_id'], 'required'],
            [['quest_id', 'player_id', 'onboarded_at', 'status', 'left_at', 'player_turn'], 'integer'],

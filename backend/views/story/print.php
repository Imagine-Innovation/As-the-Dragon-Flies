...
<div class="story-view container-fluid py-4">
    ...
    <?php foreach ($chapters as $chapter): ?>
        <section class="chapter mb-5">
            ...
            <?php endif; ?>
            <p><?= Html::encode($chapter->description) ?></p>
            ...
            foreach ($missions as $mission):
                ...
                <article class="mission mb-4">
                    ...
                    <?php endif; ?>
                    <p><?= Html::encode($mission->description) ?></p>
                    ...
                    <?php if ($npcs): ?>
                        ...
                        <?php foreach ($npcs as $npc): ?>
                            <div class="mb-3">
                                ...
                                <?php endif; ?>
                                <p><?= Html::encode($npc->description) ?></p>
                                <ul>
                    ...
                    <?php if ($actions): ?>
                        ...
                        <?php foreach ($actions as $action): ?>
                            ...
                            <div class="mb-3">
                                ...
                                <p><?= Html::encode($action->description) ?></p>
                    ...
                    <?php if ($decors): ?>
                        ...
                        <?php foreach ($decors as $decor): ?>
                            <div class="mb-3">
                                ...
                                <?php endif; ?>
                                <p><?= Html::encode($decor->description) ?></p>
                                    ...
                                    <ul>
                                        <?php foreach ($decor->decorItems as $decorItem): ?>
                                            <li>
                                                ...
                                                <?php if ($decorItem->description): ?><br><?= Html::encode($decorItem->description) ?><?php endif; ?>
                    ...
                    <?php if ($monsters): ?>
                        ...
                        <?php foreach ($monsters as $monster): ?>
                            <div class="mb-3">
                                ...
                                <?php endif; ?>
                                <p><?= Html::encode($monster->description) ?></p>
                                <p>

...
class Shopping
{
     ...
     */
    public function restoreFunding(array $playerCoins, ?int $amount = 0, ?string $coin = self::DEFAULT_COIN): bool
    {
    ...
    {
        return !isset($this->coins[$coin]) || $amount <= 0 ? 0 : (int) ($amount * $this->coins[$coin]['rate']);
    }

...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            ...
            <div class="actions">
                <a href="<?= Url::toRoute(['player/builder']) ?>" role="button" class="actions__item position-relative"
            ...
            <div class="row g-4">
                <?php foreach ($models as $player): ?>
                    <div class="col-12 col-md-6 col-lg-4 col-xl-3 col-xxl-2">
                        <?= $this->renderFile('@app/views/player-builder/snippets/card.php', ['player' => $player]) ?>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>

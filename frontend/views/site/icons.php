...
if ($devIcons) {
    $icons = [
        'dungeon-gate-svgrepo-com',
        'goblin-head-svgrepo-com',
        'gargoyle-svgrepo-com',
        'hatchet-svgrepo-com',
        'horse-head-svgrepo-com',
        'man-doing-pushups-svgrepo-com',
        'man-jumping-up-svgrepo-com',
        'iying-down-svgrepo-com',
        'woman-looking-by-a-spyglass-svgrepo-com',
        'man-riding-a-horse-svgrepo-com',
        'daggers-svgrepo-com',
        'falling-svgrepo-com',
        'wyvern-svgrepo-com',
        'secret-book-svgrepo-com',
        'set-kara-svgrepo-com',
        'skeleton-16-svgrepo-com',
        'stake-hammer-svgrepo-com',
        'stringed-isntrument-violin-viola-cello-svgrepo-com',
        'troll-svgrepo-com',
        'tshirt-svgrepo-com',
        'white-book-svgrepo-com',
        'bad-gnome',
        'basic-silhouette',
        'battle',
        'book-solid',

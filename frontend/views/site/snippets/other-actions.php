    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
        ...
        <div class="col">
            <div class="card h-100">
                <img src="<?= Url::to($imgPath . '/sm/belongings.png') ?>" class="card-img-top" alt="Pick up items">
                <div class="card-body">
        ...
        <div class="col">
            <div class="card h-100">
                <img src="<?= Url::to($imgPath . '/sm/items.png') ?>" class="card-img-top" alt="Shopping">
                <div class="card-body">
        ...
        <div class="col">
            <div class="card h-100">
                <img src="<?= Url::to($imgPath . '/sm/8.jpg') ?>" class="card-img-top" alt="Quest history">
                <div class="card-body">

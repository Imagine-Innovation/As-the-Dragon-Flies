...
<div class="<?= $row ?>">
    <div class="<?= $col ?>">
        ...
        $this->render('section1', [
            'title' => Yii::t('app/lobby', "Resume the quest '{name}'", ['name' => $quest->name]),
            'img' => Url::to("{$storyRoot}/img/{$quest->image}"),
            'paragraphs' => [
                Yii::t('app/lobby', 'Your player is currently on a quest.'),
                $iconInfo['tooltip'],
                Yii::t('app/lobby', 'Jump back into the action!'),
            ],
            'button' => [
                ...
                'tooltip' => null,
                'title' => Yii::t('app/lobby', 'Resume the quest'),
                'isCta' => true,
            ],
        ])
        ?>

...
$this->title = Yii::t('app/guest', 'Reset password');
                ...
                <div class="card" style="border-radius: 2rem;background-color: rgba(20,20,20,.85);">
                    <div class="card-body p-5">
                        ...
                        <div class="mb-md-5 mt-md-4 pb-5">
                            ...
                            <p class="mb-5"><?= Yii::t('app/guest', 'Choose your new password!') ?></p>
                            ...
                            <div class="form-group">
                                <?=
                                Html::submitButton('<img src="' . $imgPath . '/Dragonfly.svg" style="height:32px;" alt=""> ' . Yii::t('app/guest', 'Set new password'), [
                            ...
                            <?php ActiveForm::end(); ?>
                            <p class="mb-0">
                                <?= Yii::t('app/guest', "You've found your password ?") ?>
                                <a class="fw-bold" href="<?= Url::toRoute(['site/login']) ?>"><?= Yii::t('app/guest', 'Log in') ?></a>
                            </p>
                            </form>
                        </div>
                    </div>
